...
struct PWM {
  ...
  void pulse() {
    ...
    int32_t timeToSleep = micros() - previousHighTick + currentPulseLength;
    if (timeToSleep > 0) {
...
ControlPacket *currentControllerState = new ControlPacket();
...
void loop() {
  ...
  if (controllerState != NULL) {
    ...
    steeringMotor->setPosition(controllerState->horizontal);
